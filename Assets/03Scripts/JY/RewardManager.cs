...
public class RewardManager : MonoBehaviour
{
    ...
    private PlayerCtrl _playerstatus;
    ...
    {       
        ...
        _playerstatus = GameObject.Find("Player").GetComponent<PlayerCtrl>();
    ...
    public void ItemClick()
    {
        ...
        for (int h = 0; h < _itemInfoSet.Items.Count; h++)
        {
            if (GameObject.Find("Image1").GetComponent<Image>().sprite == _itemInfoSet.Items[h].ItemImage)
            {
                ...
                {
                    case 0:
                        PlayerStatus.instance.addAttackDamage(10);
                        break;
                    case 1:
                        PlayerStatus.instance.addArmorPoint(1);
                        break;
                    case 2:
                        PlayerStatus.instance.addAttackSpeed(12.0f);
                        break;
                    case 3:
                        PlayerStatus.instance.addMaxHP(10);
                        break;
                    case 4:
                        PlayerStatus.instance.addAttackSpeed(24.0f);
                        break;
                    case 5:
                        PlayerStatus.instance.addAttackDamage(20);
                        break;
                    case 6:
                        PlayerStatus.instance.addMovementSpeed(1.0f);
                        break;
                    case 7:
                        PlayerStatus.instance.addArmorPoint(2);
                        break;
                    case 8:
                        PlayerStatus.instance.addMaxHP(20);
                        break;
                    case 9:
                        PlayerStatus.instance.addMaxHP(10);
                        PlayerStatus.instance.addArmorPoint(1);
        ...
        _playerstatus.moveSpeed = PlayerStatus.instance.getMovementSpeed();
    }
